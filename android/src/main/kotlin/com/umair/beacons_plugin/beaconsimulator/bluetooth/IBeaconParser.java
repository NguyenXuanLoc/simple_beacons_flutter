...
public class IBeaconParser implements AdvertiseDataParser<IBeacon> {
    ...
    public IBeacon parseScanRecord(@NonNull ScanRecord scanRecord) {
        ...
        com.umair.beacons_plugin.beaconsimulator.bluetooth.AdvertiseDataGenerator interface. You may
        copy and distribute such a system following the terms of the GNU GPL for
        Beacon Simulator and the licenses of the other code concerned, provided that
        you include the source code of that other code when and as the GNU GPL
        requires distribution of source code and provided that you do not modify the
        com.umair.beacons_plugin.beaconsimulator.bluetooth.AdvertiseDataGenerator interface.
