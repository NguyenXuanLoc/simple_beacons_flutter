...
import com.umair.beacons_plugin.localizationactivity.LocalizationActivity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String packageName =  "com.umair.beacons_plugin.beaconsimulator"; // ActivityAbout.this.getPackageName();
        ...
        versionInformation.setText(
                getString(R.string.about_version, BuildConfig.VERSION_NAME, 111, "111"/*BuildConfig.BUILD_NUMBER*/)
        );
